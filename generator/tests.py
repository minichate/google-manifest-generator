...
class ManifestTest(unittest.TestCase):
    ...
    def test_render(self):
        rendered = str(self.manifest) # render
        self.assertTrue(rendered.index("Test"))
        self.assertTrue(rendered.index("Support"))
        
        self.failUnlessRaises(ValueError, rendered.index, "Scope")
        self.failUnlessRaises(ValueError, rendered.index, "Extension")
